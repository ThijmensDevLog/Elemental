package com.thijmensdevlog.util;
...
public class ModTags {
    ...
    public static class Blocks {
        ...
        private static TagKey<Block> createTag(String name) {
            return TagKey.of(RegistryKeys.BLOCK, Identifier.of(Elemental.MOD_ID, name));
        }
    }
    ...
    public static class Items {
        ...
        private static TagKey<Item> createTag(String name) {
            return TagKey.of(RegistryKeys.ITEM, Identifier.of(Elemental.MOD_ID, name));
        }
    }
